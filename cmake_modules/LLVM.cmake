...
add_library(LLVM-LIB INTERFACE)
target_include_directories(LLVM-LIB SYSTEM INTERFACE ${LLVM_INCLUDE_DIRS})
target_link_libraries(LLVM-LIB INTERFACE ${LLVM_AVAILABLE_LIBS})
target_compile_definitions(LLVM-LIB INTERFACE ${LLVM_DEFINITIONS} -DNOMINMAX)
